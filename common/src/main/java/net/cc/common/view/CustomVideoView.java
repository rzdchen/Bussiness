...
import net.cc.common.utils.LogUtils;
...
public class CustomVideoView extends RelativeLayout implements View.OnClickListener,
    ...
    private static final int LOAD_TOTAL_COUNT = 3;//加载重试次数
    /**
     * UI
     */
    ...
    private AudioManager audioManager;//音量控制类

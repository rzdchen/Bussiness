package net.cc.business.view.home;
...
import net.cc.business.adapter.PhotoPagerAdapter;
import net.cc.business.module.recommand.RecommandFooterValue;
import net.cc.business.module.recommand.RecommandHeadValue;
import net.cc.business.view.viewpagerindictor.CirclePageIndicator;
import net.cc.common.utils.ImageLoaderUtil;
